  ...
  return (
    <article className="w-full bg-white border border-gray-300 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
      <div className="grid md:grid-cols-3 gap-0">
        ...
        <Link
          href={`/${article.slug}`}
          className="h-44 md:h-full md:col-span-1 bg-gray-800 flex items-center justify-center relative group cursor-pointer"
        ...
        >
          ...
          <span className="text-white text-6xl font-bold opacity-40 group-hover:opacity-60 transition-opacity z-10">
            CES
          </span>
        </Link>
